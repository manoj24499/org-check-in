  ...
  return (
    ...
    >
      ...
      >
        ...
        <LocationMap latitude={latitude} longitude={longitude} accuracy={accuracy} label={employeeName} />

        <div className="px-6 py-3 bg-slate-50 text-xs text-secondary flex items-center justify-between">
          <span>
