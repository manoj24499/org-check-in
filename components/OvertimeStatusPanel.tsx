...
export default function OvertimeStatusPanel({
  ...
  return (
    <div className="rounded-lg border border-primary/35 bg-surface-2 shadow-[0_1px_2px_rgba(41,43,49,0.05)] overflow-hidden flex flex-col lg:h-full lg:min-h-0">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        {requests.length === 0 ? (
          <p className="px-4 py-10 text-center text-secondary text-sm">Nobody is working overtime right now.</p>
        ) : (
